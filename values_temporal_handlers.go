...
func (handler *dateValueHandler) Read(signature int8, values []interface{}) (interface{}, error) {
	...
	case dateSignature:
		if len(values) != dateSize {
			return nil, seabolt.NewValueHandlerError(fmt.Sprintf("expected date struct to have %d fields but received %d", dateSize, len(values)))
		}
		epochDays := values[0].(int64)
		return Date{epochDays}, nil
	}

	return nil, seabolt.NewValueHandlerError(fmt.Sprintf("unexpected struct signature provided to dateTimeValueHandler: %#x", signature))
}
...
func (handler *dateValueHandler) Write(value interface{}) (int8, []interface{}, error) {
	...
	if date, ok = value.(Date); !ok {
		return 0, nil, seabolt.NewValueHandlerError(fmt.Sprintf("passed in value %v is not supported by dateValueHandler", value))
	}
...
func (handler *localTimeValueHandler) Read(signature int8, values []interface{}) (interface{}, error) {
	...
	case localTimeSignature:
		if len(values) != localTimeSize {
			return nil, seabolt.NewValueHandlerError(fmt.Sprintf("expected local time struct to have %d fields but received %d", localTimeSize, len(values)))
		}
		nanosOfDay := values[0].(int64)
		return LocalTime{time.Duration(nanosOfDay)}, nil
	}

	return nil, seabolt.NewValueHandlerError(fmt.Sprintf("unexpected struct signature provided to localTimeValueHandler: %#x", signature))
}
...
func (handler *localTimeValueHandler) Write(value interface{}) (int8, []interface{}, error) {
	...
	if localTime, ok = value.(LocalTime); !ok {
		return 0, nil, seabolt.NewValueHandlerError(fmt.Sprintf("passed in value %v is not supported by localTimeValueHandler", value))
	}
...
func (handler *offsetTimeValueHandler) Read(signature int8, values []interface{}) (interface{}, error) {
	...
	case offsetTimeSignature:
		if len(values) != offsetTimeSize {
			return nil, seabolt.NewValueHandlerError(fmt.Sprintf("expected offset time struct to have %d fields but received %d", offsetTimeSize, len(values)))
		}
		nanosOfDay := values[0].(int64)
	...
	return nil, seabolt.NewValueHandlerError(fmt.Sprintf("unexpected struct signature provided to offsetTimeValueHandler: %#x", signature))
}
...
func (handler *offsetTimeValueHandler) Write(value interface{}) (int8, []interface{}, error) {
	...
	if offsetTime, ok = value.(OffsetTime); !ok {
		return 0, nil, seabolt.NewValueHandlerError(fmt.Sprintf("passed in value %v is not supported by offsetTimeValueHandler", value))
	}
...
func (handler *durationValueHandler) Read(signature int8, values []interface{}) (interface{}, error) {
	...
	case durationSignature:
		if len(values) != durationSize {
			return nil, seabolt.NewValueHandlerError(fmt.Sprintf("expected duration struct to have %d fields but received %d", durationSize, len(values)))
		}
	...
	return nil, seabolt.NewValueHandlerError(fmt.Sprintf("unexpected struct signature provided to durationValueHandler: %#x", signature))
}
...
func (handler *durationValueHandler) Write(value interface{}) (int8, []interface{}, error) {
	...
	if duration, ok = value.(Duration); !ok {
		return 0, nil, seabolt.NewValueHandlerError(fmt.Sprintf("passed in value %v is not supported by durationValueHandler", value))
	}
...
func (handler *localDateTimeValueHandler) Read(signature int8, values []interface{}) (interface{}, error) {
	...
	case localDateTimeSignature:
		if len(values) != localDateTimeSize {
			return nil, seabolt.NewValueHandlerError(fmt.Sprintf("expected local date time struct to have %d fields but received %d", localDateTimeSize, len(values)))
		}
	...
	return nil, seabolt.NewValueHandlerError(fmt.Sprintf("unexpected struct signature provided to localDateTimeValueHandler: %#x", signature))
}
...
func (handler *localDateTimeValueHandler) Write(value interface{}) (int8, []interface{}, error) {
	...
	if localDateTime, ok = value.(LocalDateTime); !ok {
		return 0, nil, seabolt.NewValueHandlerError(fmt.Sprintf("passed in value %v is not supported by localDateTimeValueHandler", value))
	}
...
func (handler *dateTimeValueHandler) Read(signature int8, values []interface{}) (interface{}, error) {
	...
	case dateTimeWithZoneIdSignature:
		if len(values) != dateTimeSize {
			return nil, seabolt.NewValueHandlerError(fmt.Sprintf("expected date time with zone id struct to have %d fields but received %d", dateTimeSize, len(values)))
		}
		...
		if err != nil {
			return nil, seabolt.NewValueHandlerError(fmt.Sprintf("Unable to load time zone '%s'", zone))
		}
	...
	case dateTimeWithOffsetSignature:
		if len(values) != dateTimeSize {
			return nil, seabolt.NewValueHandlerError(fmt.Sprintf("expected date time with offset struct to have %d fields but received %d", dateTimeSize, len(values)))
		}
...
func (handler *dateTimeValueHandler) Write(value interface{}) (int8, []interface{}, error) {
	...
	if dateTime, ok = value.(time.Time); !ok {
		return 0, nil, seabolt.NewValueHandlerError(fmt.Sprintf("passed in value %v is not supported by dateTimeValueHandler", value))
	}
