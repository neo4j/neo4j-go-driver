...
type sessionRouter interface {
	...
	Readers(ctx context.Context, bookmarks func(context.Context) []string, database string, boltLogger log.BoltLogger) ([]string, error)
	...
	Writers(ctx context.Context, bookmarks func(context.Context) []string, database string, boltLogger log.BoltLogger) ([]string, error)
