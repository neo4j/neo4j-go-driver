...
func NewBolt5(serverName string, conn net.Conn, log log.Logger, boltLog log.BoltLogger) *bolt5 {
	b := &bolt5{
...
func (b *bolt5) receiveMsg() interface{} {
...
func (b *bolt5) receiveSuccess() *success {
	msg := b.receiveMsg()
	if b.err != nil {
		return nil
	}
...
func (b *bolt5) connect(minor int, auth map[string]interface{}, userAgent string, routingContext map[string]string) error {
	...
	b.out.send(b.conn)
	successMsg := b.receiveSuccess()
	if b.err != nil {
		return b.err
	}

	b.connId = successMsg.connectionId
	b.serverVersion = successMsg.server
	...
	b.initializeReadTimeoutHint(successMsg.configurationHints)
...
func (b *bolt5) TxBegin(txConfig db.TxConfig) (db.TxHandle, error) {
...
func (b *bolt5) assertTxHandle(h1, h2 db.TxHandle) error {
	if h1 != h2 {
...
func (b *bolt5) TxCommit(txh db.TxHandle) error {
	...
	b.out.appendCommit()
	b.out.send(b.conn)
	successMessage := b.receiveSuccess()
	if b.err != nil {
		return b.err
	}
	// Keep track of bookmark
	if len(successMessage.bookmark) > 0 {
		b.bookmark = successMessage.bookmark
	}
...
func (b *bolt5) TxRollback(txh db.TxHandle) error {
	if err := b.assertTxHandle(b.txId, txh); err != nil {
		return err
	}
...
func (b *bolt5) discardAllStreams() {
	if b.state != bolt5Streaming && b.state != bolt5StreamingTx {
		return
	}
...
func (b *bolt5) resumeStream(s *stream) {
	b.streams.resume(s)
	b.sendPullN()
	if b.err != nil {
		return
...
func (b *bolt5) run(cypher string, params map[string]interface{}, fetchSize int, tx *internalTx5) (*stream, error) {
	...
	b.tfirst = successMessage.tfirst
	...
	stream := &stream{keys: successMessage.fields, qid: successMessage.qid, fetchSize: fetchSize}
...
func (b *bolt5) Run(cmd db.Command, txConfig db.TxConfig) (db.StreamHandle, error) {
...
func (b *bolt5) RunTx(txh db.TxHandle, cmd db.Command) (db.StreamHandle, error) {
	if err := b.assertTxHandle(b.txId, txh); err != nil {
		return nil, err
	}
...
func (b *bolt5) Keys(streamHandle db.StreamHandle) ([]string, error) {
...
func (b *bolt5) Next(streamHandle db.StreamHandle) (*db.Record, *db.Summary, error) {
	// Do NOT set b.err for this error
	stream, err := b.streams.getUnsafe(streamHandle)
	if err != nil {
		return nil, nil, err
...
func (b *bolt5) Consume(streamHandle db.StreamHandle) (*db.Summary, error) {
	// Do NOT set b.err for this error
	stream, err := b.streams.getUnsafe(streamHandle)
	if err != nil {
		return nil, err
...
func (b *bolt5) Buffer(streamHandle db.StreamHandle) error {
	// Do NOT set b.err for this error
	stream, err := b.streams.getUnsafe(streamHandle)
	if err != nil {
		return err
...
func (b *bolt5) receiveNext() (*db.Record, bool, *db.Summary) {
	res := b.receiveMsg()
	if b.err != nil {
...
func (b *bolt5) Reset() {
	...
	// Reset any pending error, should be matching bolt5Failed, so
...
func (b *bolt5) GetRoutingTable(context map[string]string, bookmarks []string, database, impersonatedUser string) (*db.RoutingTable, error) {
	if err := b.assertState(bolt5Ready); err != nil {
		return nil, err
	}
	...
	return successMessage.routingTable, nil
}

// Close sends the GOODBYE message to the Bolt server and closes the underlying connection
// Note: it could be called on another thread when driver is closed.
func (b *bolt5) Close() {
