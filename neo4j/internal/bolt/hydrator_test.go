...
func TestHydrator(outer *testing.T) {
	...
	cases := []hydratorTestCase{
		...
		},
		{
			...
			x: &db.Record{Values: []any{dbtype.NewVector(0.1, 0.2)}},
		},
		{
			name: "Vector Float32",
			build: func() {
			...
			x: &db.Record{Values: []any{dbtype.NewVector(float32(0.1), float32(0.2))}},
		},
		{
			name: "Vector Int8",
			build: func() {
			...
			x: &db.Record{Values: []any{dbtype.NewVector(int8(1), int8(2), int8(3))}},
		},
		{
			name: "Vector Int16",
			build: func() {
			...
			x: &db.Record{Values: []any{dbtype.NewVector(int16(1), int16(2), int16(3))}},
		},
		{
			name: "Vector Int32",
			build: func() {
			...
			x: &db.Record{Values: []any{dbtype.NewVector(int32(1), int32(2), int32(3))}},
		},
		{
			name: "Vector Int64",
			build: func() {
			...
			x: &db.Record{Values: []any{dbtype.NewVector(int64(1), int64(2), int64(3))}},
		},
		{
			...
			x: &db.Record{Values: []any{dbtype.NewVector[float64]()}},
		},
		{
