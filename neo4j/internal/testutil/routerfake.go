...
type RouterFake struct {
	...
	ReadersRet             []string
	ReadersHook            func(bookmarks func(context.Context) []string, database string) ([]string, error)
	WritersRet             []string
	WritersHook            func(bookmarks func(context.Context) []string, database string) ([]string, error)
	Err                    error
	CleanUpHook            func()
...
func (r *RouterFake) Readers(ctx context.Context, bookmarksFn func(context.Context) []string, database string, log log.BoltLogger) ([]string, error) {
...
func (r *RouterFake) Writers(ctx context.Context, bookmarksFn func(context.Context) []string, database string, log log.BoltLogger) ([]string, error) {
