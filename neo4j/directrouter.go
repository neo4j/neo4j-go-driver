...
func (r *directRouter) Readers(context.Context, func(context.Context) []string, string, log.BoltLogger) ([]string, error) {
	return []string{r.address}, nil
}

func (r *directRouter) Writers(context.Context, func(context.Context) []string, string, log.BoltLogger) ([]string, error) {
	return []string{r.address}, nil
}
